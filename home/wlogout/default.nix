...
let 
  ...
  #############################
  #                           #
  # Icons with dynamic colour #
  #                           #
  #############################
  
  # The following code writes a .svg file into the nix store for each icon. The svg code is simply taken from the provided wlogout icons, but the default foreground base05 colour is added as the fill colour.

  hibernate_icon = pkgs.writeText "hibernate.svg" ''<?xml version="1.0" encoding="utf-8"?>
<!-- Svg Vector Icons : http://www.onlinewebfonts.com/icon -->
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" xml:space="preserve">
<metadata> Svg Vector Icons : http://www.onlinewebfonts.com/icon </metadata>
<g><g><path d="M500,10C229.4,10,10,229.4,10,500s219.4,490,490,490s490-219.4,490-490S770.6,10,500,10z M500,885.1c-212.7,0-385.1-172.4-385.1-385.1S287.3,114.9,500,114.9S885.1,287.3,885.1,500S712.7,885.1,500,885.1z M576.5,308.7v382.4c0,42.2-34.2,76.5-76.5,76.5c-42.3,0-76.5-34.2-76.5-76.5V308.7c0-42.2,34.2-76.5,76.5-76.5C542.2,232.3,576.5,266.5,576.5,308.7z" fill="${base05}"/></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></g>
</svg>
  '';

  lock_icon = pkgs.writeText "lock.svg" ''<?xml version="1.0" encoding="utf-8"?>
<!-- Svg Vector Icons : http://www.onlinewebfonts.com/icon -->
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" xml:space="preserve">
<metadata> Svg Vector Icons : http://www.onlinewebfonts.com/icon </metadata>
    ...
    style = ''
      * {
      ...
      button {
        ...
        #lock {
          background-image: image(url("${lock_icon}"));
        }

        #logout {
          background-image: image(url("${logout_icon}"));
        }

        #suspend {
          background-image: image(url("${suspend_icon}"));
        }

        #hibernate {
          background-image: image(url("${hibernate_icon}"));
        }

        #shutdown {
          background-image: image(url("${shutdown_icon}"));
        }

        #reboot {
          background-image: image(url("${reboot_icon}"));
        }
      '';
  };
}
